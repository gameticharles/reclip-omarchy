var rules = {
  ...
  java: [
    ...
    { pattern: /(\/\*[\s\S]*?\*\/)/g, cls: "cmt" },
    { pattern: /("(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g, cls: "str" },
    { pattern: /\b(public|private|protected|static|final|abstract|class|interface|enum|extends|implements|new|this|super|return|if|else|for|while|do|switch|case|break|continue|default|try|catch|finally|throw|throws|import|package|synchronized|volatile|transient|native|instanceof|void|int|double|float|long|short|byte|char|boolean|true|false|null)\b/g, cls: "kw" },
    { pattern: /\b(\d+\.?\d*([eE][+-]?\d+)?[fFdDlL]?)\b/g, cls: "num" },
    { pattern: /\b([A-Z][a-zA-Z0-9_]*)\b/g, cls: "typ" },
    { pattern: /\b([a-zA-Z_$][a-zA-Z0-9_$]*)\s*(?=\()/g, cls: "fn" }
  ]
}
...
var langAliases = {
  ...
  rs: "rust",
  go: "go",
  sh: "shell", bash: "shell", zsh: "shell", zshrc: "shell", bashrc: "shell",
  htm: "html", xml: "html", svg: "html",
  json: "json", jsonc: "json",
  yaml: "shell", yml: "shell", toml: "shell", ini: "shell", env: "shell",
  c: "rust", cpp: "rust", h: "rust", hpp: "rust", "c++": "rust",
  java: "java", class: "java",
  cs: "java", csharp: "java",
  lua: "javascript", php: "javascript", ruby: "python", rb: "python",
  dart: "java", kotlin: "java", kt: "java", swift: "rust"
}
...
if (typeof module !== "undefined") {
  module.exports = { highlight: highlight, resolveLang: resolveLang, escapeHtml: escapeHtml }
}
